...
T["teardown removes runtime resources"] = function()
  ...
  MiniTest.expect.equality(commands_after["PinWordSymbol"], nil)
  ...
  MiniTest.expect.equality(commands_after["PinWordGrep"], nil)
  MiniTest.expect.equality(commands_after["PinWordLiveGrep"], nil)
